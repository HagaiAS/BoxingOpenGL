...
void setArenaMaterial() {
	glMaterialfv(GL_FRONT, GL_AMBIENT_AND_DIFFUSE, ARENA_AMBIENT_DIFFUSE);
	glMaterialfv(GL_FRONT, GL_SPECULAR, ARENA_SPECULAR); //reflect
	glMaterialfv(GL_FRONT, GL_SHININESS, ARENA_SHININESS);
}